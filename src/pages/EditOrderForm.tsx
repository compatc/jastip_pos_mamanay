...
const STATUS_OPTIONS: { value: OrderStatus; label: string }[] = [
  ...
  { value: "belum-ready", label: "Belum Ready" },
...
export default function EditOrderForm() {
  ...
  const { updateOrder, allOrders, loadAllOrders, orderItems, loadOrderItems, products, loadProducts, customers, loadCustomers, productDiscounts, loadAllProductDiscounts, addCustomer, accounts, loadAccounts, addProduct, productVariants, loadProductVariants } = useStore();
