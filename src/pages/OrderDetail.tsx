...
export default function OrderDetail() {
  ...
  const { allOrders, loadAllOrders, orderItems, loadOrderItems, customers, loadCustomers, markOrdersPaid } = useStore();
      ...
      <main className="flex-1 overflow-y-auto relative z-10">
        <div className="px-5 py-4 space-y-4 pb-8">
          ...
          {(order.courier || order.resi) && (
            <div className="bg-white/80 border border-pink-100/60 rounded-2xl p-4 shadow-sm shadow-pink-50">
              <label className="flex items-center gap-2 text-xs text-gray-400 mb-2 uppercase tracking-widest font-semibold">
