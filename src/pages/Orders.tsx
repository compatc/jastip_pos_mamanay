...
export default function Orders() {
  ...
  const totalPiutang = filtered
    ...
    .reduce((s, o) => s + ((o.total - (o.diskon || 0) - (o.kode_unik || 0)) - o.paid_total), 0);
  ...
  function sendReminder(order: (typeof allOrders)[0]) {
    ...
    const sisa = (order.total - (order.diskon || 0) - (order.kode_unik || 0)) - order.paid_total;
  ...
  const totalBelumBayar = baseFiltered.filter((o) => !isOrderLunas(o) && o.total > 0).reduce((s, o) => s + ((o.total - (o.diskon || 0) - (o.kode_unik || 0)) - o.paid_total), 0);
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="shrink-0 px-4 sm:px-10 pt-4 sm:pt-6 pb-3 relative z-10 space-y-3 sm:space-y-0 sm:bg-transparent">
        ...
        <div className="bg-white sm:bg-white sm:p-7 sm:rounded-2xl sm:shadow-sm sm:border sm:border-slate-200/80 space-y-3 sm:space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
              <button
                ...
                className="px-3 sm:px-5 py-2 sm:py-2.5 bg-pink-500 hover:bg-pink-600 text-white font-bold text-[11px] sm:text-sm rounded-xl shadow-sm shadow-pink-500/20 transition-all whitespace-nowrap active:scale-[0.97]"
              >
                + Order Baru
              </button>
              <div className="relative" ref={lainnyaRef}>
                <button
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-slate-200 text-slate-600 font-semibold text-[11px] sm:text-sm rounded-xl flex items-center gap-1 whitespace-nowrap shadow-sm hover:bg-slate-50 transition-all"
                >
                  Lainnya
          ...
          <div className="relative">
            ...
            {productFilter && (
              <button
                ...
                className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 p-1 bg-pink-100 hover:bg-pink-200 text-pink-500 rounded-lg transition-all"
              >
            ...
            {!productFilter && (
              <button
                ...
                className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 p-1 bg-slate-100 hover:bg-slate-200 text-slate-400 rounded-lg transition-all"
              >
          ...
          <div className="grid grid-cols-3 gap-2.5 sm:gap-4">
            <div className="bg-white sm:bg-slate-50/80 p-3 sm:p-4 rounded-2xl border border-rose-100 shadow-sm">
              <div className="flex items-center gap-2 sm:gap-2.5 mb-1 sm:mb-2">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-rose-50 flex items-center justify-center text-rose-500">
                  <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-rose-400">Belum Bayar</span>
              </div>
              ...
              <p className="text-[10px] sm:text-xs text-rose-300 font-semibold mt-0.5 sm:mt-1">{countBelumBayar} order</p>
            </div>
            <div className="bg-white sm:bg-slate-50/80 p-3 sm:p-4 rounded-2xl border border-sky-100 shadow-sm">
              <div className="flex items-center gap-2 sm:gap-2.5 mb-1 sm:mb-2">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-sky-50 flex items-center justify-center text-sky-500">
                  <PackageCheck className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-sky-400">Ready</span>
              </div>
              <p className="text-base sm:text-xl font-black text-sky-600 leading-tight">{countReady} order</p>
              <p className="text-[10px] sm:text-xs text-sky-300 font-semibold mt-0.5 sm:mt-1">Siap dikirim/diambil</p>
            </div>
            <div className="bg-white sm:bg-slate-50/80 p-3 sm:p-4 rounded-2xl border border-emerald-100 shadow-sm">
              <div className="flex items-center gap-2 sm:gap-2.5 mb-1 sm:mb-2">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-50 flex items-center justify-center text-emerald-600">
                  <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-emerald-400">Lunas</span>
              </div>
              ...
              <p className="text-[10px] sm:text-xs text-emerald-300 font-semibold mt-0.5 sm:mt-1">{todayLunasCount} order</p>
            </div>
          </div>
        </div>
      ...
      <button
        ...
        className="fixed bottom-20 right-4 z-30 w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-500/30 flex items-center justify-center transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed sm:hidden"
      >
      ...
      <button
        onClick={openWaModal}
        disabled={groupedCustomers.length === 0}
        className="fixed bottom-8 right-8 z-30 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-500/30 hidden sm:flex items-center gap-2 transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed font-bold text-sm"
      >
