  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <button
        ...
        className="fixed bottom-20 right-4 sm:right-8 z-30 w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-500/30 flex items-center justify-center transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed sm:hidden"
      >
      ...
      <button
        onClick={openWaModal}
        disabled={groupedCustomers.length === 0}
        className="fixed bottom-8 right-4 sm:right-8 z-30 px-5 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-500/30 flex items-center gap-2 transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed font-bold text-sm hidden sm:flex"
      >
